Public Class Frtb_pctz

    Private Sub Frtb_pctz_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = G_icon : Me.BackgroundImage = G_backimg
        Dim dt As DataTable = G_bm
        GS_wlbktlr2(tb_pctz_bm, dt, 1, "")
        dt = GF_CreateDataSource(G_cnnstr, "select * from tb_bmgd")
        GS_wlbktlr2(tb_pctz_gd, dt, 1, "无")
        GS_wlbktlr3(tb_pctz_lb, G_PCLB, "") '构建偏差类别下拉
    ...
    Private Sub SSSQD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SSSQD.Click
        ...
        If Labelid.Text <> "" Then
            '''''''''''''''''''''''''''''
            If GF_storelog1("修改偏差台账") = False Then
                Exit Sub
            End If ' 判断是否有权限
            ...
            GS_storelog3("修改偏差台账", "修改偏差台账") '储存到日志
        Else
            '''''''''''''''''''''''''''''
            ...
            GS_storelog3("添加偏差台账", "添加偏差台账") '储存到日志
        End If
        Me.Close()
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If MsgBox("你确定删除本条记录吗?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ''''''''''''''''''''日志权限判断
            If GF_storelog2("删除偏差台账", "删除偏差台账") = False Then
                Exit Sub
            End If
            '''''''''''''''''''''
