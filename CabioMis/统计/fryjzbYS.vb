...
Public Class fryjzbYS
    ...
    Public Function getYJSCZBdatatable(ByVal monthStr As String) As Data.DataTable
        ...
        For i As Integer = 2 To monthArr.Length Step 2
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''成品油成品油止批号
            myread.CommandText = "select top 1  tb_h195z_num from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "' order by tb_h195z_jgrq desc "
            rs = myread.ExecuteReader
            If rs.Read Then
                dataRow("成品油止批号") = rs(0)
            End If
            rs.Close()
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            myread.CommandText = "select sum(tb_h195z_n426f),sum(tb_h195z_m408e),count(*) from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "' "
            rs = myread.ExecuteReader
            If rs.Read Then
            ...
            rs.Close()
            ''''''''''''''''''''''''''''''''''报废成品油
            myread.CommandText = "select sum(tb_h195z_m408e) from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "' and tb_h195z_qaspjg='报废'"
            rs = myread.ExecuteReader
            If rs.Read Then
            ...
            myread.CommandText = "select avg(tb_h195z_c6u) from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "'  and tb_h195z_c6u>0"
            rs = myread.ExecuteReader
            If rs.Read Then
            ...
            rs.Close()
            ''''''''''''''''''''''''''''''''''''''''''''''''''''成品油收率平均值，不平均0值
            myread.CommandText = "select avg(tb_h195z_u704m) from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "'  and tb_h195z_u704m>0"
            rs = myread.ExecuteReader
            If rs.Read Then
            ...
            rs.Close()
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''成品油AA收率收率平均值，不平均0值
            myread.CommandText = "select avg(tb_h195z_q554i) from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "'  and tb_h195z_q554i>0"
            rs = myread.ExecuteReader
            If rs.Read Then
            ...
            rs.Close()
            ''''''''''''''''''''''''''''''''不为报废的成品油量除以不为报废的批数
            myread.CommandText = "select   count(*), sum(tb_h195z_m408e) from tb_h195z where tb_h195z_jgrq between '" & tmpMonthLow & "' and '" & tmpMonthhigh & "'  and  tb_h195z_qaspjg<>'报废'"
            rs = myread.ExecuteReader
            If rs.Read Then
                Try
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ''''''''''''''''''''''''''''''''''''''''''''''''''''''
        DeepDoDataTable.DelDataColAtIndex(ylbdb, "1,2,4,5,6,7,11,12,13,14,15,16,17,18")
