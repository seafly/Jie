Public Class DeepDoDataTable
    ...
    Public Shared Function GF_czmctb(ByVal tbmc As DataTable, ByVal cxstr As String, ByVal pxstr As String) As DataTable
        Dim foundRows() As DataRow
    ...
    Public Shared Function GF_czmctb(ByVal tbmc As DataTable, ByVal cxstr As String) As DataTable
        Dim foundRows() As DataRow
    ...
    End Function
    '数据库一个不带返回值的SQL语句过程
    Public Shared Sub GS_upztxx(ByVal strcnn As String, ByVal strsql As String)
        Dim cnn As New OleDb.OleDbConnection(strcnn)
        cnn.Open()
        Dim myread As New OleDb.OleDbCommand(strsql, cnn)
    ...
    '连接字符串,SQL语句,插入的表
    Public Shared Function GF_upztxx2(ByVal strcnn As String, ByVal strsql As String, ByVal strTbName As String) As String
        GF_upztxx2 = ""
        '    Try
        Dim cnn As New OleDb.OleDbConnection(strcnn)
        cnn.Open()
        ...
        myread.CommandText = "select @@IDENTITY from " & strTbName & ""
    ...
    Public Shared Function GF_getstringsql(ByVal strcnn As String, ByVal strsql As String, ByVal str2 As String) As String
        ...
        If Not rs.eof Then
            ...
            gndlr = DeepDoStr.GF_removedh(gndlr) '这里得到内容，字段间用str2隔开
        End If
