Public Class Frtb_x824p
    ...
    Private Sub SSSQD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SSSQD.Click
        ...
        If fn = "tb_x832p" Then
            ...
            For i As Integer = 0 To ComboBox2.SelectedIndex
                If _D.GF_CreateDataSource("select  tb_x832pkc_id  from tb_x832pkc where tb_x832pkc_cplb = '" & ComboBox1.Text & "'and tb_x832pkc_mingc= '" & cpdm(i) & "' and tb_x832pkc_jiagdm= '" & jiagdm(i) & "'and tb_x832pkc_num = '" & ph.Text & "'").Rows.Count > 0 Then
        ...
        For i As Integer = 0 To ComboBox2.SelectedIndex
            Select Case fn
                Case "tb_h195z"   '成品油入库'''''''''''''''''''''''''''''''''''''''''''''''''''
                    sql0 = "select  tb_h195zkc_id from tb_h195zkc where tb_h195zkc_cplb = '" & ComboBox1.Text & "'and  tb_h195zkc_mingc= '" & cpdm(i) & "' and  tb_h195zkc_jiagdm= '" & jiagdm(i) & "'and  tb_h195zkc_num = '" & ph.Text & "'"
                    dt0 = GF_CreateDataSource(G_cnnstr, sql0)
                    If dt0.Rows.Count > 0 Then
                        ' 累加
                        sql = "update  tb_h195zkc set  tb_h195zkc_sykczl = tb_h195zkc_sykczl+ " & sykczl(i) & " , tb_h195zkc_ckcl = tb_h195zkc_ckcl+ " & sykczl(i) & " , tb_h195zkc_kczl = tb_h195zkc_kczl+ " & sykczl(i) & "  where tb_h195zkc_id = '" & dt0.Rows(0)("tb_h195zkc_id") & "' "
                    ...
                    Else
                        '添加
                        sql = "insert into tb_h195zkc(tb_h195zkc_num2,tb_h195zkc_num,tb_h195zkc_jgrq,tb_h195zkc_m408e,tb_h195zkc_e95w,tb_h195zkc_o460g,tb_h195zkc_p495h,tb_h195zkc_y878r,tb_h195zkc_c998u,tb_h195zkc_g179y,tb_h195zkc_b989t,tb_h195zkc_n426f,tb_h195zkc_s621k,tb_h195zkc_u704m,tb_h195zkc_q554i,tb_h195zkc_t673l,tb_h195zkc_bz,tb_h195zkc_qcrq,tb_h195zkc_y855q,tb_h195zkc_c6u,tb_h195zkc_c28u,tb_h195zkc_m403e,tb_h195zkc_b991u,tb_h195zkc_k309c,tb_h195zkc_a948s,tb_h195zkc_j268b,tb_h195zkc_l356d,tb_h195zkc_o485g,tb_h195zkc_h192z,tb_h195zkc_g158y,tb_h195zkc_d36v,tb_h195zkc_qarq,tb_h195zkc_qaspjg,tb_h195zkc_qajgsm,tb_h195zkc_rkts,tb_h195zkc_sbtb,tb_h195zkc_sbid,tb_h195zkc_glid,tb_h195zkc_xbtb,tb_h195zkc_czrgh,tb_h195zkc_o460gt,tb_h195zkc_y878rt,tb_h195zkc_g179yt,tb_h195zkc_qcczrgh,tb_h195zkc_qaczrgh,tb_h195zkc_y876r,tb_h195zkc_qcsh,tb_h195zkc_bf,tb_h195zkc_bfmx,tb_h195zkc_zfbz,tb_h195zkc_tpyy,tb_h195zkc_llzph,tb_h195zkc_llzzl,tb_h195zkc_llzpht,tb_h195zkc_pf,tb_h195zkc_ybd5kgph,tb_h195zkc_ybd5kgzl,tb_h195zkc_ybd5kgpht,tb_h195zkc_ypybdph,tb_h195zkc_ypybdzl,tb_h195zkc_ypybdpht,tb_h195zkc_wgbh,tb_h195zkc_wjbgrq,tb_h195zkc_dry,tb_h195zkc_sykcsm,tb_h195zkc_sykczl,tb_h195zkc_yg,tb_h195zkc_ckcl,tb_h195zkc_rkbz,tb_h195zkc_cw,tb_h195zkc_bzxs,tb_h195zkc_kczl,tb_h195zkc_cplb,tb_h195zkc_mingc,tb_h195zkc_jiagdm,tb_h195zkc_hblsrkbz,tb_h195zkc_hblsrkzl,tb_h195zkc_rkrq,tb_h195zkc_mscw,tb_h195zkc_wzcw,tb_h195zkc_bfcw) "
                        sql &= "select tb_h195z_num2,tb_h195z_num,tb_h195z_jgrq,tb_h195z_m408e,tb_h195z_e95w,tb_h195z_o460g,tb_h195z_p495h,tb_h195z_y878r,tb_h195z_c998u,tb_h195z_g179y,tb_h195z_b989t,tb_h195z_n426f,tb_h195z_s621k,tb_h195z_u704m,tb_h195z_q554i,tb_h195z_t673l,tb_h195z_bz,tb_h195z_qcrq,tb_h195z_y855q,tb_h195z_c6u,tb_h195z_c28u,tb_h195z_m403e,tb_h195z_b991u,tb_h195z_k309c,tb_h195z_a948s,tb_h195z_j268b,tb_h195z_l356d,tb_h195z_o485g,tb_h195z_h192z,tb_h195z_g158y,tb_h195z_d36v,tb_h195z_qarq,tb_h195z_qaspjg,tb_h195z_qajgsm, " & Rktss(i) & ",'tb_h195z'," & Labelid.Text & ",null,null,tb_h195z_czrgh,tb_h195z_o460gt,tb_h195z_y878rt,tb_h195z_g179yt,tb_h195z_qcczrgh,tb_h195z_qaczrgh,tb_h195z_y876r,tb_h195z_qcsh,tb_h195z_bf,tb_h195z_bfmx,tb_h195z_zfbz,tb_h195z_tpyy,tb_h195z_llzph,tb_h195z_llzzl,tb_h195z_llzpht,tb_h195z_pf,tb_h195z_ybd5kgph,tb_h195z_ybd5kgzl,tb_h195z_ybd5kgpht,tb_h195z_ypybdph,tb_h195z_ypybdzl,tb_h195z_ypybdpht,tb_h195z_wgbh,tb_h195z_wjbgrq,tb_h195z_dry,tb_h195z_sykcsm, " & sykczl(i) & ",'" & yg(i) & "'," & sykczl(i) & ",'" & tb_x825p_rkbz.Text & "','" & cw(i) & "', '" & bzxs(i) & "'," & sykczl(i) & ",'" & ComboBox1.Text & "','" & cpdm(i) & "','" & jiagdm(i) & "',1,0,'" & sj.Text & "','" & mscw(i) & "','" & wzcw(i) & "','" & bfcw(i) & "' from vw_h195z where tb_h195z_id = '" & Labelid.Text & "'"
                        Kcid = GF_upztxx2(G_cnnstr, sql, "tb_h195zkc")
                        '添加冷库数据
                        UpdateTbname(Kcid, fn & "kc", storage(i).Text, storage(i).Tag)
                        '集成下步ID
                        xbid &= Kcid & ","
                    End If
                ...
                Case "tb_x825p"   '毛油入库''''''''''''''''''''''''''''''''''''''''''
                    ...
                    If dt0.Rows.Count > 0 Then
                        ' 累加
                        sql = "update tb_x825pkc set  tb_x825pkc_sykczl = tb_x825pkc_sykczl+ " & sykczl(i) & " , tb_x825pkc_ckcl =tb_x825pkc_ckcl+ " & sykczl(i) & " ,tb_x825pkc_kczl =tb_x825pkc_kczl+ " & sykczl(i) & "  where tb_x825pkc_id = '" & dt0.Rows(0)(0) & "' "
                        GS_upztxx(G_cnnstr, sql)
                        Dim a As String = GF_ZlNew(storage(i)) '转为负数
                    ...
                    Else
                        ...
                        Kcid = GF_upztxx2(G_cnnstr, sql, "tb_x825pkc")
                        '添加冷库数据
                        UpdateTbname(Kcid, fn & "kc", storage(i).Text, storage(i).Tag)
                        '集成下步ID
                        xbid &= Kcid & ","
                ...
                Case "tb_x832p"   '成品粉入库''''''''''''''''''''''''''''''''''''''''''''''''
                    ...
                    Else
                        ...
                        Kcid = GF_upztxx2(G_cnnstr, sql, "tb_x832pkc")
                        UpdateTbname(Kcid, fn & "kc", storage(i).Text, storage(i).Tag) '添加冷库数据
                        xbid &= Kcid & ","
                    End If
            End Select
            '  保存到进出货表
            ...
            '集成进出货下步ID
            Jchid &= GF_upztxx2(G_cnnstr, sql3, "tb_jch") & ","
        Next
        ...
        If Jchid <> "" Then
            ...
            For i As Integer = 0 To UBound(JchidArray)
                Try
                    UpdateTbname(JchidArray(i), "tb_jch", storage(i).Text, Gf_ZdNew(xbtb, "tb_jch", storage(i)))
                Catch ex As Exception
                End Try
            Next
        End If
    ...
    Private Sub TextBox2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles KcOne.TextChanged, KcTwo.TextChanged, KcThree.TextChanged, KcFour.TextChanged
        Try
