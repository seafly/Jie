...
Public Class Frcgdhbb
    ...
    Private Sub Frcgdhbb_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        wz()
        '''''''''''''''''''''''''''''''''''''''''进入时默认显示全部信息
        CheckBox1.Checked = True : CheckBox2.Checked = True : CheckBox3.Checked = True : CheckBox4.Checked = True : CheckBox5.Checked = True : CheckBox6.Checked = True
        showsj()
    ...
    Private Function dtqg() As DataTable '请购中数据请购单生效的
        Dim sqlqg As String = "select tb_qgcg_id,tb_qgcg_wpfl,tb_qgcg_jhdh,tb_qgcg_qgbm,tb_qgcg_qgr,tb_qgcg_qgrq,tb_qgcg_yqdhrq,tb_qgcg_dm,tb_qgcg_pm,tb_qgcg_ggxh,tb_qgcg_dw,tb_qgcg_qgsl,tb_qgcg_yqyt,tb_qgcg_qgzt,tb_qgcg_qgdsfsx,null from tb_qgcg where tb_qgcg_wpfl='备品备件'and tb_qgcg_qgdsfsx='是'  and tb_qgcg_xbid is null"
        Dim dt As DataTable = GF_CreateDataSource(G_cnnstr, sqlqg)
        Return dt
    End Function
    Private Function dtqg2() As DataTable '请购中数据请购单未生效的
        Dim sqlqg As String = "select tb_qgcg_id,tb_qgcg_wpfl,tb_qgcg_jhdh,tb_qgcg_qgbm,tb_qgcg_qgr,tb_qgcg_qgrq,tb_qgcg_yqdhrq,tb_qgcg_dm,tb_qgcg_pm,tb_qgcg_ggxh,tb_qgcg_dw,tb_qgcg_qgsl,tb_qgcg_yqyt,tb_qgcg_qgzt,tb_qgcg_qgdsfsx,null from tb_qgcg where tb_qgcg_wpfl='备品备件' and tb_qgcg_qgdsfsx='否' and tb_qgcg_xbid is null"
        Dim dt As DataTable = GF_CreateDataSource(G_cnnstr, sqlqg)
        Return dt
    End Function
    Private Function dtqg3() As DataTable '请购中数据请购单退单的
        Dim sqlqg As String = "select tb_qgcg_id,tb_qgcg_wpfl,tb_qgcg_jhdh,tb_qgcg_qgbm,tb_qgcg_qgr,tb_qgcg_qgrq,tb_qgcg_yqdhrq,tb_qgcg_dm,tb_qgcg_pm,tb_qgcg_ggxh,tb_qgcg_dw,tb_qgcg_qgsl,tb_qgcg_yqyt,tb_qgcg_qgzt,tb_qgcg_qgdsfsx,null from tb_qgcg where tb_qgcg_wpfl='备品备件' and tb_qgcg_qgdsfsx='退单' and tb_qgcg_xbid is null"
        Dim dt As DataTable = GF_CreateDataSource(G_cnnstr, sqlqg)
        Return dt
    End Function
    Private Function dtcg() As DataTable '采购的数据
        Dim sqlcg As String = "select tb_cg_id,tb_cg_wpfl,tb_cg_jhdh,tb_cg_qgbm,tb_cg_qgr,tb_cg_qgrq,tb_cg_yqdhrq,tb_cg_dm,tb_cg_pm,tb_cg_ggxh,tb_cg_dw,tb_cg_qgsl,tb_cg_yqyt,tb_cg_qgzt,tb_cg_qgdsfsx,tb_cg_dj,tb_cg_cgdh,tb_cg_rq,tb_cg_fzr,tb_cg_dgzl,tb_cg_ysbm,tb_cg_fqcs,tb_cg_sfbh,tb_cg_yjdhrq1,tb_cg_cgbz from tb_cg where tb_cg_wpfl='备品备件' and tb_cg_xbid is null"
        Dim dt As DataTable = GF_CreateDataSource(G_cnnstr, sqlcg)
        Return dt
    End Function
    Private Function dtdhgz() As DataTable '已到货但未验收
        Dim sql As String = "select tb_dhgz_id,tb_dhgz_wpfl,tb_dhgz_jhdh,tb_dhgz_qgbm,tb_dhgz_qgr,tb_dhgz_qgrq,tb_dhgz_yqdhrq,tb_dhgz_dm,tb_dhgz_pm,tb_dhgz_ggxh,tb_dhgz_dw,tb_dhgz_qgsl,tb_dhgz_yqyt,tb_dhgz_qgzt,tb_dhgz_qgdsfsx,tb_dhgz_dj,tb_dhgz_cgdh,tb_dhgz_rq,tb_dhgz_fzr,tb_dhgz_dgzl,tb_dhgz_ysbm,tb_dhgz_fqcs,tb_dhgz_sfbh,tb_dhgz_yjdhrq,sum(tb_dhgz_yshgl) as '总合格量',tb_dhgz_yszq,tb_dhgz_yssx2,tb_dhgz_ysr,null from tb_dhgz "
        Dim sql0 As String = "where tb_dhgz_wpfl='备品备件' and tb_dhgz_sfys is null group by tb_dhgz_id, tb_dhgz_wpfl,tb_dhgz_qgbm,tb_dhgz_qgr,tb_dhgz_qgrq,tb_dhgz_dm,tb_dhgz_pm,tb_dhgz_ggxh,tb_dhgz_dw,tb_dhgz_qgsl,tb_dhgz_yqyt,tb_dhgz_qgzt,tb_dhgz_qgdsfsx,tb_dhgz_cgdh,tb_dhgz_rq,tb_dhgz_fzr,tb_dhgz_dgzl,tb_dhgz_ysbm,tb_dhgz_fqcs,tb_dhgz_sfbh,tb_dhgz_yssx2,tb_dhgz_ysr,tb_dhgz_yszq,tb_dhgz_dj,tb_dhgz_yqdhrq,tb_dhgz_yjdhrq,tb_dhgz_jhdh"
