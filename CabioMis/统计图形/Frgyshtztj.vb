Public Class Frgyshtztj
    'Private zxl As String
    Private Sub Frgyshtztj_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ButtonOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOK.Click
        ...
        With dj
            For q As Integer = 0 To UBound(l)
                ...
                For i As Integer = 0 To datedb.Rows.Count - 1
                    ...
                    Dim sql As String = "select count(*) from tb_gysshtz where tb_gysshtz_rq between '" & tt1 & "' and '" & tt2 & "'"
                    sql &= " and tb_gysshtz_nb='" & lb & "'"
        ...
        'allsj = "Suppliers auidt checklist  " & n & "," & allsj
        'zxl = allsj
        '''''''''''''''''''''''''''''''''
        showl.DataSource = dj
    showchart(dj)
    ...
    '    Dim zbxl As String = "a2," & GF_GetExcelSerByX("c", "n", 4) & "," & GF_GetExcelSerByX("c", "n", 5)
    '    'MsgBox(zbxl & vbCrLf & allsj)
    '    GS_FillExcel(Application.StartupPath() & "\Template\供应商现场审核台账.xls", zbxl, zxl, Me)
    'End Sub
    ...
    Private Sub showchart(ByVal dj As DataTable)
        ...
        ClassDeepChart.G_Chart_ShowColumn(Chart1, False, dj, "Suppliers auidt checklist  " & ComboBox1.Text, DataVisualization.Charting.Docking.Bottom, Color.Blue, ys, 2, dj.Columns.Count - 2, 0, dj.Rows.Count - 2)
    End Sub
