Public Class Frtb_wjxmjl

    Private Sub SSSQX_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SSSQX.Click
        Me.Close()
    End Sub

    Private Sub Frtb_wjxmjl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SSSQD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SSSQD.Click
        ...
        If Labelid.Text <> "" Then
            ...
            GS_storelog3("修改外检项目记录", "修改外检项目记录") '储存到日志
        Else
            '''''''''''''''''''''''''''''
            If GF_storelog1("添加外检项目记录") = False Then
                Exit Sub
            End If ' 判断是否有权限
            '''''''''''''''''''''
            ...
            GS_storelog3("添加外检项目记录", "添加外检项目记录") '储存到日志
        End If
        Me.Close()
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If MsgBox("你确定删除本条记录吗?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ''''''''''''''''''''日志权限判断
            If GF_storelog2("删除外检项目记录", "删除外检项目记录") = False Then
                Exit Sub
            End If
            '''''''''''''''''''''
