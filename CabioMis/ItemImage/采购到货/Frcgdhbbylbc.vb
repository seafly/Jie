...
Public Class Frcgdhbbylbc
    ...
    Private Function dtqg() As DataTable '请购中生效数据
        Dim sqlqg As String = "select tb_qgcg_wpfl,tb_qgcg_qgbm,tb_qgcg_qgr,tb_qgcg_qgrq,tb_qgcg_yqdhrq,tb_qgcg_dm,tb_qgcg_pm,tb_qgcg_ggxh,tb_qgcg_dw,tb_qgcg_qgsl,tb_qgcg_yqyt,tb_qgcg_qgzt,tb_qgcg_jhdh,tb_qgcg_qgdsfsx from tb_qgcg where (tb_qgcg_wpfl='包材' or  tb_qgcg_wpfl='原料') and tb_qgcg_qgdsfsx='是' and tb_qgcg_xbid is null"
