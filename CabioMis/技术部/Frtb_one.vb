Public Class Frtb_one
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ps = Int((dt.Rows(i)(2) * dt.Rows(i)(3)) / num)
            Dim si As New ListViewItem.ListViewSubItem(ListView2.Items(i), ps)
            ListView2.Items(i).SubItems.Insert(4, si)
        Next
        For i As Integer = 0 To dt.Rows.Count - 1
            Dim pjz As Double = num / dt.Rows(i)(3)
            pjz = Int((pjz * 10)) / 10
            Dim pjz2 As String = Int(pjz)

            Dim km1 As Integer = Int((pjz - Math.Floor(pjz)) * 10)
            If km1 >= 5 Then
                pjz2 = pjz2 & ".5"
            End If
            pjz = pjz2
    ...
    Private Sub showsj()
        ...
        sql = "select tb_h195zkc_ID,tb_h195zkc_num,tb_h195zkc_sykczl,tb_h195zkc_c6u,tb_h195zkc_yg,tb_h195zkc_jgrq,tb_h195zkc_pf,tb_h195zkc_jiagdm,tb_h195zkc_mingc,tb_h195zkc_rkbz from tb_h195zkc  where tb_h195zkc_sykczl > 0 and tb_h195zkc_qaspjg='合格' and tb_h195zkc_yg='生产'  order by tb_h195zkc_jgrq"

        sql1 = "select tb_h195zkc_ID,tb_h195zkc_num,tb_h195zkc_sykczl,tb_h195zkc_c6u,tb_h195zkc_yg,tb_h195zkc_jgrq,tb_h195zkc_pf,tb_h195zkc_jiagdm,tb_h195zkc_mingc,tb_h195zkc_rkbz from tb_h195zkc where tb_h195zkc_sykczl <= 0 and tb_h195zkc_qaspjg='合格' and tb_h195zkc_yg='生产'  order by tb_h195zkc_jgrq"
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        ''''''''''''''''''''''''
        '设定1号塔配料批号
        Dim qztemp As String = ClassPhgn.ClassPhgn_Get("1号塔配料单", "-") '得到当前批号+1的批号
        If qztemp = "" Then
        ...
        End If
        ''''''''''''''''''''''''''''''''''''''
        Dim sql As String = "Insert into tb_x823p(tb_x823p_dpzl,tb_x823p_cfsl,tb_x823p_th,tb_x823p_t678l,tb_x823p_num2,tb_x823p_jgrq,tb_x823p_num,tb_x823p_kczl,tb_x823p_sbtb,tb_x823p_sbid,tb_x823p_cplb,tb_x823p_jhhl,tb_x823p_czrgh ,tb_x823p_mingc,tb_x823p_jiagdm,tb_x823p_dpmx) values(" & dpzl & "," & ps & ",'1号塔配料'," & num & ",'" & ListView2.SelectedItems(0).SubItems(1).Text & "',getdate(),'" & ph & "'," & num & ",'tb_h195zkc'," & ListView2.SelectedItems(0).SubItems(0).Text & ",'" & ComboBox1.Text & "'," & ListView2.SelectedItems(0).SubItems(3).Text & ",'" & G_dlrgh & "','" & tb_x823p_mingc.Text & "','" & tb_x823p_jiagdm.Text & "'," & dpzl & ")"
        '插入记录到粉剂配料
        ...
        ClassPhgn.ClassPhgn_SetDqz2("1号塔配料单") '使当前批号+1
