Public Class Frtb_xgqc

    Private Sub SSSQX_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SSSQX.Click
        Me.Close()
    End Sub

    Private Sub Frtb_xgqc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Icon = G_icon : Me.BackgroundImage = G_backimg
        GS_qhjd(Me) '回车键切换焦点，备注除外
        ComboBox1.SelectedIndex = 0
        tb_y864q_p516h.SelectedIndex = 0
    ...
    Private Sub SSSQD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SSSQD.Click
        ...
        If Labelid.Text <> "" Then
            ...
            GS_storelog3("修改小罐QC：" & tb_y864q_num.Text.Trim, "修改QC") '储存到日志
        Else
            ''''''''''''''''''''
            ...
            If ComboBox1.SelectedIndex = 1 Then
                Dim sql As String = "update tb_b970t set tb_b970t_qcsh='是' where tb_b970t_num='" & tb_y864q_num.Text & "'"
                GS_upztxx(G_cnnstr, sql)
            End If
            GS_storelog3("添加小罐QC：" & tb_y864q_num.Text.Trim, "添加QC") '储存到日志
        End If
        Me.Close()
    End Sub
    ...
    Private Sub Buttdel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Buttdel.Click
        ...
        sql = sql & vbCrLf & "update tb_b970t set tb_b970t_qcsh='否' where tb_b970t_num='" & tb_y864q_num.Text & "'"
        GS_upztxx(G_cnnstr, sql)
        GS_storelog3("删除小罐QC：" & tb_y864q_num.Text.Trim, "删除QC") '储存到日志
        Me.Close()
    End Sub
End Class