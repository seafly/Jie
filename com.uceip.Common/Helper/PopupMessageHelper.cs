...
/****************************************
 * 作者：Huangfs
 * 功能：使用该类，可以实现右下角的弹出界面。
 * 日期：2008-09-26  
 * 版本：0.1
 * 联系方式：QQ 119219405 Email:amwggyy504@163.com
 * http://www.cnblogs.com/amwggyy504/archive/2008/09/26/1299544.html 
 * **************************************/
namespace com.uceip.Common.Helper
{
    /// <summary>
    /// 使用该类，可以实现右下角的弹出界面。
    /// </summary>
    public class PopupMessageHelper
    {
        ...
        /// </summary>
        public void Slowly(int Width, int Height, string Title, string Content)
        {
        ...
        /// <param name="Width">弹出框的宽度</param>
        /// </summary>
        public void Quickly(int Width, int Height, string Title, string Content)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static PopupMessageHelper Display
        {
            get
            {
